...
describe("BankAccount class", () => {
  ...
  describe("printStatement method", () => {
    it("prints logs of deposit and withdrawal with balance from latest to oldest", () => {
      ...
      expect(consoleLogMock.mock.calls[1][0]).toEqual("14/01/2023 || || 500.00 || 2500.00");
      expect(consoleLogMock.mock.calls[2][0]).toEqual("13/01/2023 || 2000.00 || || 3000.00");
      expect(consoleLogMock.mock.calls[3][0]).toEqual("10/01/2023 || 1000.00 || || 1000.00");
